...
globalkeys = gears.table.join(
    ...
    awful.key({ modkey },   "c",    function () awful.util.spawn("code") end,
              {description = "launch vscode", group = "custom"}),

	-- Screenshot
	awful.key( {  }, "Print", scrot_full,
			  {description = "Take ss of entire screen", group = "screenshot"}),
	awful.key( { modkey }, "Print", scrot_selection,
			  {description = "Take ss of selection", group = "screenshot"}),
	awful.key( { "Shift" }, "Print", scrot_window,
			  {description = "Take ss of focused window", group = "screenshot"})
	-- scot_delay - take ss with delay
